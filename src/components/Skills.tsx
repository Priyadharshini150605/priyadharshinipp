...
export function Skills() {
  ...
  const technologies = ["React", "Node.js", "MongoDB", "Figma", "JavaScript", "TypeScript", "HTML/CSS", "Power BI", "Git", "Android Studio", "Express.js", "Java"];
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            return <Card key={category.title} className="glass-card p-6 transition-smooth hover:scale-105 animate-fade-in-up" style={{
                    ...
                    <div className="space-y-4">
                      {category.skills.map(skill => <div key={skill.name} className="space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-foreground text-left text-base font-medium">{skill.name}</span>
